                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('autors.index')" :active="route().current('autors.*')">
                                    Autores
                                </JetNavLink>

                                <JetNavLink :href="route('categories.index')" :active="route().current('categories.*')">
                                    Categorías
                                </JetNavLink>

                                 <JetNavLink :href="route('movies.index')" :active="route().current('movies.*')">
                                    Peliculas
                                </JetNavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')">
                         ...
                         <JetResponsiveNavLink :href="route('autors.index')" :active="route().current('autors.*')">
                            Autores
                        </JetResponsiveNavLink>

                        <JetResponsiveNavLink :href="route('categories.index')" :active="route().current('categories.*')">
                            Categorías
                        </JetResponsiveNavLink>

                        <JetResponsiveNavLink :href="route('movies.index')" :active="route().current('movies.*')">
                            Peliculas
                        </JetResponsiveNavLink>
                    </div>
